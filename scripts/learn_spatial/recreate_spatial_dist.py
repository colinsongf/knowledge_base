...
#Reading recreate_spatial_mean. 
spatial_mean = npy.loadtxt(str(sys.argv[1]))
# Note that this returned a 2D array!
print spatial_mean.shape
spatial_mean = spatial_mean.reshape((number_objects,number_objects))

#Reading recreate_spatial_mean. 
spatial_dev = npy.loadtxt(str(sys.argv[2]))
# Note that this returned a 2D array!
print spatial_dev.shapel
spatial_dev = spatial_dev.reshape((number_objects,number_objects))
